...
We also include a list of colorblind-safe palettes by checking for thresholds with the package `colorblindcheck`. You can read more about the process in `vignette("check-colors")`.
