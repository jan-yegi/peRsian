...
persian_palettes <- list(
  ...
  isfahan = c("#1c3c67", "#a0853d", "#a3b3b0", "#600c17", "#a5959a", "#a96d62"),
  ...
  abbas = c("#919c9a", "#aba680", "#273642", "#7c7872", "#f0e8d5"),
  reyhaneh = c("#e24448", "#8b1a26", "#e06d1c", "#784030"),
  berlin = c("#b5c3c6", "#b07f5b", "#6893a7", "#304f56", "#b16342", "#9a3d49", "#d4b568", "#d6657a"),
  pooran = c("#976763", "#ead9b9", "#e93b3c", "#3861be", "#acae93", "#608b93"),
...
#' @export
persian_palette <- function(name, n, direction = c(1, -1), selection = c("sequential", "evenly")) {
